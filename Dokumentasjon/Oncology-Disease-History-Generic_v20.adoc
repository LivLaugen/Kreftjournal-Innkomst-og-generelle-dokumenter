...
= Sammendrag av helseinformasjon (Sykehistorie)


== Metadata


TemplateId:: Oncology-Disease-History-Generic_v20
...
a|
* Onkologi sykehistorie (no.dips.oncology: TM7)
5+a|*Semver* + 
CLUSTER: _at0003_
...
D
|at0009| 0..1| DV_TEXT | Utvidet informasjon om kreftdiagnose
a|


Designkommentar:

|at0012| 0..1| DV_TEXT | Anatomisk lokalisering
a|


 Dersom den anatomiske lokaliseringen inkluderes i feltet "Problem/diagnosenavn" via prekoordinerte koder blir dette dataelementet overflødig.
...
|at0069| 0..1| DV_TEXT | Kroppside
a|
* Høyre side
* Venstre side
* Høyre og venstre (bilateral)
* Midtlinje
...
|====
== Oppsummeringer
== Oppsummering genetikk/arv
[options="header", cols="3,3,5,5,30"]
|====
|NodeId|Attr.|RM Type| Name |Description
5+a|*Oppsummering genetikk/arv* + 
